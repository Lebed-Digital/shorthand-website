        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <div className="privacy-card">
            ...
            <div className="privacy-desc">
              ...
              <strong style={{ color: 'var(--text)' }}>Groq:</strong> fallback AI language model processing, used if OpenAI is temporarily unavailable. Groq does not use customer data to train models and offers a DPA. Data is not retained after the API response.<br /><br />
