---
title: "How to Write a Student Behavior Report (With a Full Example)"
subtitle: "The five parts of a report that holds up in meetings, a complete worked example, and the wording traps that undo them."
date: "2026-06-30"
...
excerpt: "A step-by-step guide to writing a student behavior report, with a complete example, the five required sections, and how to keep the language objective enough to survive an IEP meeting or records request."
faq:
  - q: "What should a student behavior report include?"
    a: "Five parts: student and context information (dates, settings, who observed), an objective description of the behaviors with frequency, the pattern over time including any triggers, what interventions were tried and how the student responded, and a factual summary. Every claim should trace back to a dated note. Leave out diagnoses, guesses about causes, and comparisons to other students."
  - q: "What is an example of objective behavior reporting?"
    a: "Objective: \"Between 3/1 and 3/26, J. left his seat without permission 14 times during independent work, an average of 3 to 4 times per week. Each time, he returned within one minute of a verbal prompt.\" Subjective: \"J. is constantly out of his seat and defiant.\" The first counts observable events; the second interprets character. Only the first belongs in a report."
  - q: "How is a behavior report different from an incident report?"
    a: "An incident report documents one event: what happened, when, who was involved, what was done. A behavior report summarizes a pattern across weeks or months: frequency, settings, triggers, interventions, and trends. Incident reports feed behavior reports. If you are asked for \"a report on his behavior lately,\" you are being asked for the pattern, not a single story."
  - q: "Who reads student behavior reports?"
    a: "More people than you expect: parents, administrators, counselors, IEP and 504 teams, evaluators, sometimes outside providers, and occasionally attorneys in due process disputes. Behavior reports can also be part of a student's educational record that parents can request. Write every report as if the student's family and a hearing officer will both read it, because someday they might."
---
...
![A teacher turning scattered behavior memories and notes into a calm dated student behavior report](/blog-illustrations/student-behavior-report-scattered-notes.webp)
...
>
> **Student:** J.M., Grade 3 | **Prepared by:** G. Lebed, classroom teacher
> **Period covered:** March 1 to April 12 | **Settings observed:** classroom, hallway transitions, recess (M/W/F duty)
>
...
If this language style is new to you, our guide on [how to document student behavior as a teacher](/blog/how-to-document-student-behavior-as-a-teacher) drills the objective-writing habit, and the [complete behavior documentation guide](/blog/teacher-behavior-documentation-guide) covers the whole system this report sits on top of.
