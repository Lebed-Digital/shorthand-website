---
title: "Your First Year as a Special Education Paraprofessional: Honest Advice from an RBT Turned Teacher"
subtitle: "Five lessons on pairing, de-escalation, and documentation from someone who spent over a decade in the classroom before becoming a teacher."
date: "2026-07-14"
author: "Gregory Lebed"
relatedPosts:
  - "special-education-behavior-tracking-software"
  - "iep-behavior-documentation-checklist"
  - "behavior-intervention-plan-vs-iep"
excerpt: "Starting as a special education paraprofessional can feel disorienting. A former RBT turned classroom teacher shares five honest lessons on pairing, de-escalation, and documentation for your first year."
faq:
  - q: "What does a special education paraprofessional do?"
    a: "A paraprofessional works directly alongside students with IEPs or behavior plans, often one-to-one, supporting them through transitions, academic tasks, and behavior regulation. The role involves building trust with students, following the behavior plans set by the team, and documenting what happens so teachers and specialists have accurate information to work from."
  - q: "What is pairing in behavior support, and why does it matter for new paraprofessionals?"
    a: "Pairing means building a positive relationship with a student before making demands of them, so the student experiences you as safe and helpful rather than as someone who only corrects behavior. New paraprofessionals who skip this step and jump straight to giving directions often struggle to get cooperation later."
  - q: "How should a new paraprofessional respond when a student is escalating?"
  ...
  - q: "What is ABC data, and why do paraprofessionals need to understand it?"
    a: "ABC stands for Antecedent, Behavior, and Consequence: what happened right before a behavior, what the student actually did, and what happened right after. Paraprofessionals often have the clearest view of these details, and writing objective, observable notes instead of guesses about motivation makes that data useful to the rest of the team."
---
...
- How do they communicate when they need help?
- What does stress look like before it becomes a larger problem?
...
- Move other students to a safer area.
- Remove nearby objects that could be thrown or damaged.
- Clear an exit or pathway.
- Call for additional trained support.
- Bring over a needed visual, communication device, or calming item.
- Supervise the rest of the class so the lead adult can focus.
...
- Entering the room without becoming distressed.
- Sitting for 30 seconds longer.
- Accepting a different cup.
- Asking for a break instead of leaving.
- Completing one problem after refusing the entire page.
- Returning to the group after calming down.
- Keeping hands safe during a difficult transition.
- Tolerating an adult saying, "Not yet."
...
- **Behavior:** What did the student do that could be seen or heard?
...
Different [behavior plans](/blog/behavior-intervention-plan-vs-iep) may require different kinds of data. You might count how many times a behavior occurs, record how long it lasts, check whether it happened during a set interval, or take a brief narrative note.

*If you want a fuller breakdown of what to track and how to organize it over time, [the teacher's guide to documenting student behavior](/blog/teacher-behavior-documentation-guide) covers logs, IEP records, and intervention plans in more depth.*
...
- Recognize a pattern.
- Adjust a support strategy.
- Prepare for an IEP or behavior meeting.
- Explain progress to a family.
- Determine whether an intervention is working.
- Notice a trigger that everyone had previously missed.
...
*Paraprofessionals, RBTs, and classroom teachers often need different things from a documentation tool. If you are trying to figure out what fits your role, [this comparison of special education behavior tracking software](/blog/special-education-behavior-tracking-software) walks through a few options built for very different parts of the job.*
...
Years after learning these lessons, I built [ShortHand](https://getshorthandapp.com) to solve one of the biggest frustrations I kept running into: capturing accurate observations before they disappeared. If you're curious what that looks like in practice, you can try the [guided demo](https://app.getshorthandapp.com?demo=true) in about two minutes. No account required.
