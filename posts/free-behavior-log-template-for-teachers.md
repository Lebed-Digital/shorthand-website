---
title: "Free Behavior Log Template for Teachers"
...
![A teacher writing behavior notes on a clipboard in an elementary classroom](/teacher-behavior-log.png)
...
By tracking these details, you can write much better communication home. For example, you can use our guide on [5 Sample Emails to Parents About Student Behavior](/blog/sample-emails-to-parents-about-student-behavior) to write precise, fact-based reports that parents can actually use to support their child.
...
* **Date / Time:** Be as specific as possible. Patterns often emerge around specific times of day, like right before lunch or during transitions.
* **Student Name:** Use first name and last initial to maintain privacy.
