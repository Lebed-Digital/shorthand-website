---
title: "How to Write Honest Behavior Comments on a Report Card (Without Getting a Call Home)"
...
faq:
  - q: "How do you write a behavior comment on a report card without upsetting parents?"
    a: "Use a three-part formula: state the observable behavior, give the frequency or context, then point the comment toward growth. Swap character judgments like 'defiant' or 'disrespectful' for objective descriptions of what the behavior looks like. Parents respond to specifics and solutions, not labels."
  - q: "What words should you avoid in report card behavior comments?"
    a: "Avoid labels like 'disrespectful,' 'aggressive,' 'lazy,' 'defiant,' and 'mean.' These read as character attacks to parents and offer no path forward. Replace them with observable descriptions: instead of 'defiant,' write 'struggles to comply with initial verbal directives during transitions.'"
  - q: "How do you write a report about a student's behavior professionally?"
    a: "Treat behavior like data, not a personality flaw. Describe what you observe, when it happens, and what support is in place. The more specific and clinical your language, the harder it is for a parent to argue with. Vague judgments invite defensiveness. Specific observations invite partnership."
  - q: "What is the best formula for writing behavior comments on a report card?"
    a: "The three-part formula that holds up: (1) name the exact observable behavior, (2) give the frequency or context so it does not sound like a blanket attack, (3) end with growth language or the specific strategy being used to support the student. Every comment should answer: what is happening, when does it happen, and what are we doing about it."
---
...
- Instead of "disrespectful," use "is learning to communicate disagreement with adults in a respectful manner."
- Instead of "aggressive," use "frequently uses physical touch rather than verbal communication during peer conflicts."
