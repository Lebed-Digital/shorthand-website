...
If a student has been struggling, you should have already reached out. You can learn [how to write behavior emails to parents](/blog/how-to-write-behavior-emails-to-parents) to prevent this issue.
...
You can also check out our full list of [report card comments for behavior](/blog/report-card-comments-for-behavior) for more ideas.
...
Get started at [Try ShortHand free →](https://app.getshorthandapp.com?demo=true). Or try the [free report card comment generator](/free-tool) to draft a comment right now, no sign-up needed.
