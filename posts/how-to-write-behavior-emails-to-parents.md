---
title: "How to Write Behavior Emails to Parents (Without Overthinking Every Word)"
...
![A teacher turning emotional reactions and fuzzy behavior memories into a short factual and empathetic parent email](/blog-illustrations/behavior-email-facts-and-empathy.webp)
...
That's the problem I built [ShortHand](https://app.getshorthandapp.com?demo=true) to solve. You log a quick behavior note during the school day -- one tap to select the student, one tap for what you saw, done in a few taps. Later, ShortHand uses that log to draft a parent communication that's already clear, specific, and professional. You review it, adjust the tone if you want, and send.
