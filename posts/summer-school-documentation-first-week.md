---
title: "What I Document for Every Student During the First Week of Summer School"
...
faq:
  - q: "What should teachers document during the first week of summer school?"
    a: "Focus on five areas: student strengths, academic observations, behavior patterns, parent communication, and accommodations in use. You do not need lengthy notes. A brief entry with a date and one or two sentences is enough to establish a baseline before the session gets busy."
  - q: "How do you document student behavior during ESY programs?"
    a: "Track patterns, not just incidents. Note the time of day when difficulties occur, common triggers, and which interventions worked. A quick note recorded in the moment is far more reliable than trying to reconstruct events from memory two weeks later during a meeting."
  - q: "Why is parent communication documentation important during summer school?"
    a: "Summer programs move quickly and staff changes are common. A dated record of what was discussed, what parents shared, and what follow-up was promised protects you and helps the next person who works with that student. Memory is not enough when a parent says they were never contacted."
  - q: "What is the best way to track accommodations during ESY?"
    a: "Document what was implemented, how the student responded, and whether adjustments were needed. What worked during the school year may not transfer to a new environment with different staff, hours, and routines. The first week is when you find out what actually works, not just what the paperwork says."
---
...
That experience is what made me start thinking seriously about [how to track student behavior data](/blog/how-to-track-student-behavior-data) as a daily habit instead of a crisis response.
...
Patterns usually emerge before problems become significant. The [teacher documentation forms vs. apps comparison](/blog/teacher-documentation-forms-vs-apps) I put together covers this in more depth, but the core idea applies in any setting: small consistent observations beat one detailed incident report written weeks later.
...
A [parent communication log](/blog/free-parent-communication-log-for-teachers) does not need to be complicated. The goal is to avoid relying on memory weeks later when a parent says they were never told about something.
...
For teachers managing students with formal plans, the [IEP behavior documentation checklist](/blog/iep-behavior-documentation-checklist) is a good companion for making sure your records hold up in a formal setting.
...
If you want a ready-made structure to build this habit on, the [teacher documentation log template](/blog/teacher-documentation-log-template) gives you a starting point you can adapt for an ESY setting.
...
When conference time arrives, you will also want to know [what to bring to a parent-teacher conference about behavior](/blog/what-to-bring-to-parent-teacher-conference-about-behavior), because the same documentation habit that helps you through summer school will carry you through those conversations too.
