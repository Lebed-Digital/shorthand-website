...
![A teacher turning a dense behavior intervention plan packet into one practical shared card and consistent classroom observations](/blog-illustrations/behavior-plan-packet-to-usable-card.webp)
...
| Category | Details |
| :--- | :--- |
| **Target Behavior** | What exactly does the student do? (e.g., Throws pencils, puts head on desk) |
| **Function of Behavior** | Why are they doing it? (e.g., Seeking attention, avoiding math work) |
| **Replacement Behavior** | What should they do instead? (e.g., Ask for help, take a short walk) |
| **Interventions & Strategies** | How will the teacher respond? (e.g., Provide visual timer, ignore minor tapping) |
| **Data Collection Method** | How will we prove it works? (e.g., Daily frequency tally, duration log) |
| **Who is Responsible** | Who is tracking this? (e.g., Classroom teacher, paraprofessional) |
