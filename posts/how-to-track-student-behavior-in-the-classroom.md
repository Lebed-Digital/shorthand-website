...
- Marcus is only disruptive on days when he comes in from the gym before class
- Sofia's focus drops every afternoon around 1:30
...
Once you've got a few weeks of notes built up, a tool like Ask ShortHand lets you ask a question directly, something like "how has Marcus been doing during transitions lately?", and get an answer pulled from what you've actually logged, instead of scrolling back through entries yourself to spot the pattern.
...
- Off-task or disengaged
- Peer conflict
- Refusal to work
- Positive behaviors (helping a classmate, staying on task, self-regulating)
...
- **Frequency patterns** - Is the behavior getting better, worse, or staying the same?
- **Time patterns** - Does it happen more in certain subjects, times of day, or with certain groupings?
- **Trigger patterns** - What tends to come right before the behavior?
