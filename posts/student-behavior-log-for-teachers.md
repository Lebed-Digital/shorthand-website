...
![A worried teacher in a parent conference trying to remember behavior details while a dated student behavior log creates a clear record](/blog-illustrations/student-behavior-log-freeze-moment.webp)
...
ShortHand is the behavior log built into your phone, no spreadsheet required. You can document the facts in seconds and have the data ready for your next meeting. Try it free at [getshorthandapp.com](https://app.getshorthandapp.com?demo=true).
