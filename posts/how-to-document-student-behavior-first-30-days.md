---
title: "How to Document Student Behavior During the First 30 Days of School"
...
faq:
  - q: "What student behaviors should teachers document during the first month of school?"
    a: "Focus on patterns, not single incidents. Track refusal behaviors, difficulty transitioning, frequent redirections, incomplete work, peer conflicts, and emotional regulation challenges. Also document positives: leadership, academic growth, improved self-regulation. A pattern that shows up in week one often looks very different by October, and early notes help you tell that story."
  - q: "How should teachers write objective behavior documentation?"
    a: "Describe what you saw or heard, not how you interpreted it. Instead of 'student was unmotivated,' write 'student completed 2 of 10 assigned problems after two prompts.' Stick to observable actions: what the student did, how long it lasted, and under what conditions. Objective notes hold up in parent meetings and intervention discussions. Interpretations get disputed."
  - q: "How often should teachers document student behavior during the first 30 days?"
    a: "You do not need to document every student every day. Target students who stand out early: frequent redirections, missing work, unusual emotional responses, or strong peer conflicts. A one-sentence note with a date is enough. Consistency matters more than length. A brief note on day 3 is worth more than a detailed report written from memory in November."
  - q: "Why does early behavior documentation matter for MTSS and IEP meetings?"
    a: "MTSS and IEP teams ask when a behavior started and how often it occurs. If your earliest documentation is from November, you lose two months of baseline data. First-month notes establish whether a behavior was present from the start or developed mid-year, which directly shapes intervention decisions and referral timelines."
---
...
![A busy teacher during the first month of school turning early behavior observations into a calm baseline timeline](/blog-illustrations/first-30-days-baseline-notes.webp)
...
**Less helpful:**
"Student was disrespectful and had a bad attitude during math."

**More helpful:**
"Student refused to begin independent math assignment after two teacher prompts. Placed head on desk for approximately 10 minutes. Oct 2, 9:40am, math independent work block."
...
See [how to track student behavior data](/blog/how-to-track-student-behavior-data) for a deeper look at identifying patterns across multiple students.
...
[ShortHand](https://getshorthandapp.com) was built for exactly this: log a quick note in seconds, pull up a student's full history before a meeting, and let the app draft a parent message from your notes when you need it. Free to start.

If you prefer paper or a spreadsheet setup, the [student behavior log for teachers](/blog/student-behavior-log-for-teachers) has printable options worth bookmarking.
...
If a student ends up needing Tier 2 support, the documentation you gathered in September becomes the foundation of every conversation after that. See [how to document Tier 2 interventions for MTSS](/blog/how-to-document-tier-2-interventions-for-mtss) for what comes next once early patterns lead to formal intervention.
...
If you are starting fresh in the fall and want a practical way to build that habit before the year begins, [this guide on starting your documentation system before September](/blog/summer-school-build-documentation-system-before-september) is a good starting point.
